        # Asa: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/asa.git

        ## Objective

        ASA (Adversarial Sensitivity Analysis) is a 7-fang forensic screener that stress-tests meta-analytic conclusions against 85 adversarial scenarios.
        ...
        - Code: https://github.com/mahmood726-cyber/asa.git
        - Dashboard: https://mahmood726-cyber.github.io/asa/
